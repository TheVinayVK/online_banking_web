...
public class RegisterServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
          Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/rkbankdata1","root","rk@2003");
          ...
          ps.executeUpdate();
          response.sendRedirect("adminnewregistration.jsp?message=Account successfully registered! Your account number is: " + accountNumber + " and your Temp password is: " + password);
